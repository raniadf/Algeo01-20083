    ...
    public static double[] SolveSPL(Matrix M, String SPLtype) {
        ...
        // Case 3 : Many Solution
            ...
            while (true) {
                ...
                // PRINT SOLUTION
                // If countOne = 1 and firstidx != last column index -> solution[firstidx] = last column
                ...
                if (countOne>1){
                    ...
                    if (countOne==2 && temp[temp.length-1]==1){
                        System.out.print("x" + (i+1) + " = 0" + String.format("%.2f", Func.getElmt(M, row, temp.length-1)));
                        System.out.println();
                    }

                    else {
                        boolean firstElmt=false;
                        ...
                        for (i=0; i < temp.length; ++i){
                            ...
                            if (i!=firstIdx && temp[i]!=0 && firstElmt){
                                if (Func.getElmt(M, row, i) > 0){
                                    System.out.print(" - " + String.format("%.3f", Func.getElmt(M, row, i)) + "x" + (i+1));
                                } else {
                                    System.out.print(" + " + String.format("%.3f", Math.abs(Func.getElmt(M, row, i))) + "x" + (i+1));
                                }
                            }

                            if (!firstElmt && i!=firstIdx && temp[i]!=0){
                                System.out.print(String.format("%.3f", Math.abs(Func.getElmt(M, row, i))) + "x" + (i+1));
                                firstElmt = true;
                            }
                        }
